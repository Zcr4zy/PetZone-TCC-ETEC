...
namespace PetZone.Controllers
{
    public class AdminGenerosController : Controller
    {
        ...
        public AdminGenerosController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        // GET: AdminGeneros/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: AdminGeneros/Create
